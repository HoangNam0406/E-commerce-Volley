        ...
        <div class="flex flex-col md:flex-row gap-8">
            ...
            <aside class="w-full md:w-1/4">
                <div class="bg-white p-4 rounded shadow">
                    ...
                    <ul class="space-y-2">
                        <li><a href="<?php echo APP_URL; ?>/products" class="text-red-600 font-medium">All Products</a></li>
    ...
    endforeach; ?>
                    ...
                    <?php if (!empty($pagination) && $pagination['total_pages'] > 1): ?>
                        <div class="flex justify-center mt-8 gap-2">
                            <?php for ($i = 1; $i <= $pagination['total_pages']; $i++): ?>
                                <a href="?page=<?php echo $i; ?>" class="px-4 py-2 border rounded <?php echo $i === $pagination['current_page'] ? 'bg-red-600 text-white border-red-600' : 'bg-white text-gray-600 hover:bg-gray-50'; ?>">
                                    <?php echo $i; ?>
                                </a>
                            <?php
        endfor; ?>
                ...
                <?php
                    ...
                    <div class="bg-white p-8 rounded shadow text-center">
                        ...
                        <p class="text-gray-500">There are currently no products available in this section.</p>
                    </div>
                <?php
endif; ?>
            </div>
